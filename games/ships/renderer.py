...
class FogOfWarRenderer(BaseRenderer):
    def __init__(self, **kwargs):
        ...
        self.uncharted_background = None
    ...
    def render(self, entities, gui_widgets):
        ...
        discovered_world.blit(world, (0, 0))
        discovered_world.blit(self.alpha_mask, self.camera.world_to_screen(self.mask_position), special_flags=pygame.BLEND_RGBA_MULT)
